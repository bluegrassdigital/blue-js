...
<dd><p>A collection of javascript event utility functions</p>
</dd>
...
**Kind**: inner typedef of <code>[dom](#module_dom)</code>  
**Properties**
...
* [events](#module_events)
    * [.trigger(el, name)](#module_events.trigger)
